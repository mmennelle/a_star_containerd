...
def wait_for_file(filename = '/data/maze.txt'):
...
def load_maze(filename='/data/maze.txt'):
    with open(filename, 'r') as f:
        maze = [list(line.strip()) for line in f.readlines()]
    return maze


def save_solved_maze(maze, filename='/data/solved_maze.txt'):
...
def main():
    ...
    solved_maze_file = '/data/solved_maze.txt'
